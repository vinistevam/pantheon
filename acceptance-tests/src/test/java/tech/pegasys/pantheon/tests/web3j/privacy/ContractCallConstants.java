...
public final class ContractCallConstants {
  protected ContractCallConstants() {}
  ...
  protected static final PrivateTransaction DEPLOY_CONTRACT =
  ...
  protected static final PrivateTransaction SET_FUNCTION_CALL =
      PrivateTransaction.builder()
          .nonce(1)
          .gasPrice(Wei.of(1000))
          .gasLimit(3000000)
  ...
  protected static final PrivateTransaction GET_FUNCTION_CALL =
      PrivateTransaction.builder()
          .nonce(2)
          .gasPrice(Wei.of(1000))
          .gasLimit(3000000)
