        ...
        SECP256K1.KeyPair keyPair = SECP256K1.KeyPair.create(
                SECP256K1.PrivateKey.create(
                        new BigInteger(
                                ...
                                16)));
        SECP256K1.KeyPair keyPair1 = SECP256K1.KeyPair.create(
                SECP256K1.PrivateKey.create(
                        new BigInteger(
                                "c87509a1c067bbde78beb793e6fa76530b6382a4c0241e5e4a9ec0a0f44dc0d3",
                                16)));
        SECP256K1.KeyPair keyPair2 = SECP256K1.KeyPair.create(
                SECP256K1.PrivateKey.create(
                        new BigInteger(
                                "ae6ae8e5ccbfb04590405997ee2d52d2b330726137b875053c36d94e974d162f",
                                16)));
        Address address = Address.fromHexString(
                Credentials.create("8f2a55949038a9610f50fb23b5883af3b4ecb3c3bb792cbcefbd1542c692be63")
                        .getAddress());
        Address address1 = Address.fromHexString(
                Credentials.create("c87509a1c067bbde78beb793e6fa76530b6382a4c0241e5e4a9ec0a0f44dc0d3")
                        .getAddress());
        Address address2 = Address.fromHexString(
    ...
    public void test1() {
        ...
        final PrivateTransaction DEPLOY_CONTRACT =
                PrivateTransaction.builder()
                        ...
                        .privateFrom(BytesValue.wrap(PUBLIC_KEY_1.getBytes(UTF_8)))
                        .privateFor(
                                Lists.newArrayList(BytesValue.wrap(PUBLIC_KEY_2.getBytes(UTF_8))))
                        .restriction(BytesValue.wrap("restricted".getBytes(UTF_8)))
                        .signAndBuild(
                                SECP256K1.KeyPair.create(
                                        SECP256K1.PrivateKey.create(
        ...
        final PrivateTransaction SET_FUNCTION_CALL =
                PrivateTransaction.builder()
                        ...
                        .privateFor(
                                Lists.newArrayList(BytesValue.wrap(PUBLIC_KEY_1.getBytes(UTF_8))))
                        .restriction(BytesValue.wrap("restricted".getBytes(UTF_8)))
                        .signAndBuild(
                                SECP256K1.KeyPair.create(
                                        SECP256K1.PrivateKey.create(
